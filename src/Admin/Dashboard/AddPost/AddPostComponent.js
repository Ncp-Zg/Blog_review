...
import { doPosts } from '../../../redux/ActionCreators/postActionCreators'
...
const AddPostComponent = () => {
    ...
    const {user,userId} = useSelector((state)=>({user:state.auth.user,userId:state.auth.user_id}) )
    ...
    const handleSubmit = (e)=>{
        ...
        dispatch(doPosts(data,image,setProgress));
